...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-glow-primary hover:scale-105 active:scale-95",
        ...
        hero: "gradient-primary text-primary-foreground shadow-medium hover:shadow-large hover:scale-105 active:scale-95",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 hover:shadow-glow hover:scale-105 active:scale-95",
        teal: "bg-teal text-secondary-foreground hover:bg-teal-dark hover:scale-105 active:scale-95",
        glass: "bg-card/80 backdrop-blur-sm border border-border text-foreground hover:bg-card hover:shadow-medium",
      },
      size: {
